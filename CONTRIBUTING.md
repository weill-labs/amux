...
- `go run ./cmd/check-pr-ready` finds worker PRs that are green, Claude-approved, and conflict-free, then nudges the owning pane that the PR is ready for human merge.
